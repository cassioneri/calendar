...
// https://tinyurl.com/y7r3b36v
bool is_leap_year(year_t year) {
  return (!(year % 4))  && ((year % 100) || (!(year % 400)));
}

// https://tinyurl.com/ydhv2sch
day_t last_day_of_month(year_t year, month_t month) {
  switch (month) {
  case 2:
...
// https://tinyurl.com/ybjdh7ky
bool is_leap_year(year_t __y) {
  return __y % 4 == 0 && (__y % 100 != 0 || __y % 400 == 0);
}

// https://tinyurl.com/y855v8vw
day_t last_day_of_month(year_t __y, month_t month) {
...
auto const months = [](){
  ...
  void Scan(benchmark::State& state) {
    for (auto _ : state)
      for (uint32_t i = 0; i < years.size(); ++i)
